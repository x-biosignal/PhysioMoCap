...
- [`detectEventsZeni()`](https://x-biosignal.github.io/PhysioMoCap/reference/detectEventsZeni.md)
...
- [`detectPushOffDeficit()`](https://x-biosignal.github.io/PhysioMoCap/reference/detectPushOffDeficit.md)
  : Detect push-off deficit (reduced ankle A2 power / plantarflexor
  output)
...
- [`dimensionlessJerk()`](https://x-biosignal.github.io/PhysioMoCap/reference/dimensionlessJerk.md)
...
- [`gdiBasis()`](https://x-biosignal.github.io/PhysioMoCap/reference/gdiBasis.md)
  : Build a Gait Deviation Index feature basis from a normative
  reference
...
- [`grfLandmarks()`](https://x-biosignal.github.io/PhysioMoCap/reference/grfLandmarks.md)
  : Extract stance-phase landmarks from a time-normalised vertical GRF
  curve
...
- [`hamstringQuadRatio()`](https://x-biosignal.github.io/PhysioMoCap/reference/hamstringQuadRatio.md)
  : Conventional and functional hamstring-to-quadriceps ratios
- [`harmonicRatio()`](https://x-biosignal.github.io/PhysioMoCap/reference/harmonicRatio.md)
...
- [`jointCoordinateSystem()`](https://x-biosignal.github.io/PhysioMoCap/reference/jointCoordinateSystem.md)
  : Build embedded anatomical segment coordinate systems from marker
  clusters
...
- [`movementSmoothness()`](https://x-biosignal.github.io/PhysioMoCap/reference/movementSmoothness.md)
  : Movement-smoothness battery (SPARC + LDLJ)
- [`movementTime()`](https://x-biosignal.github.io/PhysioMoCap/reference/movementTime.md)
...
- [`peakVelocity()`](https://x-biosignal.github.io/PhysioMoCap/reference/peakVelocity.md)
...
- [`pipelineACLrts()`](https://x-biosignal.github.io/PhysioMoCap/reference/pipelineACLrts.md)
  : ACL return-to-sport pipeline (limb symmetry index)
- [`pipelineAmputee()`](https://x-biosignal.github.io/PhysioMoCap/reference/pipelineAmputee.md)
  : Amputee prosthetic-side work-asymmetry pipeline
- [`pipelineCPgait()`](https://x-biosignal.github.io/PhysioMoCap/reference/pipelineCPgait.md)
  : Cerebral-palsy gait pipeline (GDI + pathology flags)
- [`pipelinePDfog()`](https://x-biosignal.github.io/PhysioMoCap/reference/pipelinePDfog.md)
  : Parkinson's freezing-of-gait pipeline (freeze index)
- [`pipelineStrokePropulsion()`](https://x-biosignal.github.io/PhysioMoCap/reference/pipelineStrokePropulsion.md)
...
- [`plotBlandAltman()`](https://x-biosignal.github.io/PhysioMoCap/reference/plotBlandAltman.md)
...
- [`plotPhasePortrait()`](https://x-biosignal.github.io/PhysioMoCap/reference/plotPhasePortrait.md)
  : Plot phase portrait
- [`plotPressureMap()`](https://x-biosignal.github.io/PhysioMoCap/reference/plotPressureMap.md)
...
- [`plotTUG()`](https://x-biosignal.github.io/PhysioMoCap/reference/plotTUG.md)
...
- [`pressureTimeIntegral()`](https://x-biosignal.github.io/PhysioMoCap/reference/pressureTimeIntegral.md)
...
- [`print(`*`<SkeletonModel>`*`)`](https://x-biosignal.github.io/PhysioMoCap/reference/print.SkeletonModel.md)
  : Print a SkeletonModel object
- [`print(`*`<benchmark_agreement>`*`)`](https://x-biosignal.github.io/PhysioMoCap/reference/print.benchmark_agreement.md)
...
- [`print(`*`<detected_events>`*`)`](https://x-biosignal.github.io/PhysioMoCap/reference/print.detected_events.md)
  : Print method for detected events
- [`print(`*`<dtw_clustering>`*`)`](https://x-biosignal.github.io/PhysioMoCap/reference/print.dtw_clustering.md)
  : Print DTW clustering result
- [`print(`*`<dtw_result>`*`)`](https://x-biosignal.github.io/PhysioMoCap/reference/print.dtw_result.md)
  : Print DTW result
...
- [`print(`*`<multi_trial_phases>`*`)`](https://x-biosignal.github.io/PhysioMoCap/reference/print.multi_trial_phases.md)
  : Print method for multi-trial phases
- [`print(`*`<segmented_phases>`*`)`](https://x-biosignal.github.io/PhysioMoCap/reference/print.segmented_phases.md)
  : Print method for segmented phases
- [`print(`*`<waveform_pca>`*`)`](https://x-biosignal.github.io/PhysioMoCap/reference/print.waveform_pca.md)
  : Print waveform PCA result
- [`print(`*`<waveform_umap>`*`)`](https://x-biosignal.github.io/PhysioMoCap/reference/print.waveform_umap.md)
...
- [`readPressureFrame()`](https://x-biosignal.github.io/PhysioMoCap/reference/readPressureFrame.md)
...
- [`sensoryOrganizationTest()`](https://x-biosignal.github.io/PhysioMoCap/reference/sensoryOrganizationTest.md)
  : Sensory Organization Test (SOT) equilibrium and sensory-ratio
  scoring
...
- [`timeToPeakTorque()`](https://x-biosignal.github.io/PhysioMoCap/reference/timeToPeakTorque.md)
  : Time to peak torque
- [`timeToPeakVelocity()`](https://x-biosignal.github.io/PhysioMoCap/reference/timeToPeakVelocity.md)
